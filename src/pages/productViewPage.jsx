...
//   // check availablity of an product 
...
//                 <span className="text-green-600">{availability.deliveryCharge}</span>{' '}
//                 <span className="line-through text-gray-500 ml-1">{availability.originalCharge}</span>
//                 <span 
//                   className="ml-2 inline-flex items-center justify-center w-4 h-4 rounded-full bg-gray-200 text-gray-600 text-xs cursor-pointer"
...
//           <li>• Express Delivery available for this pincode</li>
