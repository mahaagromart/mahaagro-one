...
const Home = () => {
    ...
    const [BannerDataTwo, setBannerTwoData] = useState([]);
    const [BannerDataThree, setBannerThreeData] = useState([]);
    const [BannerDataFour, setBannerFourData] = useState([]);
        ...
        try {
            ...
            if (Array.isArray(response) && response.length > 0) {
                ...
                if (firstResponse.message === "SUCCESS" && firstResponse.retval === "SUCCESS") {
                    ...
                    setBannerTwoData(BannerType.filter((el) => el.bannerType === "Banner 2"));
                    setBannerThreeData(BannerType.filter((el) => el.bannerType === "Banner 3"));
                    setBannerFourData(BannerType.filter((el) => el.bannerType === "Banner 4"));
                } else {
